...
public class CirculerImageView extends ImageView {
	...
	private static final boolean DEFAULT_CIRCLED_IMAGE = true;
	...
	private boolean mCircledImage = DEFAULT_CIRCLED_IMAGE;
	...
	public CirculerImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.CirculerImageView, defStyle, 0);

		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.CirculerImageView_border_width,
				DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.CirculerImageView_border_color,
				DEFAULT_BORDER_COLOR);
		mCircledImage = a.getBoolean(
				R.styleable.CirculerImageView_circled_image,
				DEFAULT_CIRCLED_IMAGE);
	...
	public void setSquareImage(boolean isShapeSquare) {
		mCircledImage = !isShapeSquare;
	}
